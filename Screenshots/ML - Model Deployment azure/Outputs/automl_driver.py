...
workspace_name = "project" # PLACEHOLDER
subscription_id = "69f4558c-3ba3-4310-a3da-9c2183efd2d6" # PLACEHOLDER
resource_group = "BtechPrg" # PLACEHOLDER
experiment_name = "project" # PLACEHOLDER
iteration = "66"  # PLACEHOLDER
run_id = "AutoML_4ad17099-2e09-4f63-becf-b123f9d968b1_66"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':False,'enable_stack_ensembling':False,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'whitelist_models':None,'compute_target':'prg','enable_dnn':True,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':1440,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':1440,'max_concurrent_iterations':1,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'project','path':'./sample_projects/project','primary_metric':'AUC_weighted','region':'centralindia','resource_group':'BtechPrg','subscription_id':'69f4558c-3ba3-4310-a3da-9c2183efd2d6','task_type':'classification','validation_size':0.1,'test_size':0.1,'vm_type':'STANDARD_DS3_V2','workspace_name':'project','label_column_name':'Fault','positive_label':None,'save_mlflow':True,'enable_batch_run':True,'dataset_id':'d77d1bd7-e56f-4776-b7b4-3901d415a0e0'} # PLACEHOLDER
pipeline_spec = "{\"objects\": [{\"class_name\": \"StandardScaler\", \"module\": \"sklearn.preprocessing\", \"param_args\": [], \"param_kwargs\": {\"with_mean\": false, \"with_std\": false}, \"prepared_kwargs\": {}, \"spec_class\": \"preproc\"}, {\"class_name\": \"XGBoostClassifier\", \"module\": \"automl.client.core.common.model_wrappers\", \"param_args\": [], \"param_kwargs\": {\"booster\": \"gbtree\", \"colsample_bytree\": 1, \"eta\": 0.5, \"gamma\": 0.1, \"max_depth\": 10, \"max_leaves\": 255, \"n_estimators\": 600, \"objective\": \"reg:logistic\", \"reg_alpha\": 0, \"reg_lambda\": 1.4583333333333335, \"subsample\": 0.8, \"tree_method\": \"auto\"}, \"prepared_kwargs\": {}, \"spec_class\": \"sklearn\"}], \"pipeline_id\": \"d3dfdaea97bac29dd4d77bc010bbc33d414209cf\", \"module\": \"sklearn.pipeline\", \"class_name\": \"Pipeline\", \"pipeline_name\": \"{ StandardScaler, XGBoostClassifier }\"}" # PLACEHOLDER
pipeline_id = "d3dfdaea97bac29dd4d77bc010bbc33d414209cf" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"d77d1bd7-e56f-4776-b7b4-3901d415a0e0\"}}" # PLACEHOLDER
